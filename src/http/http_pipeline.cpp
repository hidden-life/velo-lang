...
namespace Velo::Http {
    auto handleRawHttpRequest(Interpreter::Interpreter &interpreter, const IR::Module &module,
        std::string_view rawRequest, std::string_view handlerName) -> HttpPipelineResult {
        ...
        const auto handlerResult = executeHttpHandler(interpreter, module, parseResult.request, handlerName);
